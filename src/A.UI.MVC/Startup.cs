...
namespace ApplicationWebMVC
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.CustomConfigForControllers();
      services.AddMultipleSingletonServices();
      services.AddMultipleScopedServices(Configuration);
      services.AddMultipleTransientServices();
